...
<body>
   ...
   <header class="hero info">
       <div id="navbar" class="navbar top">
        ...
        <nav class="desktop-nav">
         ...
         <li><div class="dropdown">
             <button class="dropbtn"><a  href="index.php#cases">
         ...
         <li>  <div class="dropdown">
             ...
             <div class="dropdown-content">
                ...
                <a href="#education-benefits">Education Benefits</a>
                <a href="#employment-benefits">Employment Benefits</a>
                 <a href="#climate-benefits">Climate and Environmental Benefits</a>
             </div>
         </div></li>
         <li><div class="dropdown">
             <button class="dropbtn"><a  href="index.php#cases">Aqua
                 Business Model</a></button>
             <div class="dropdown-content">
                <a href="index.php#what">What are the financial benefits</a>
       ...
       <div class="content">
           <h2 class="title">Aqua Social Benefits<br/></h2>
           <p id="research"></p>
       </div>
   </header> 
 ...
 <nav class="mobile-nav">
    <ul class="mobile-nav__items">
        ...
        <li class="mobile-nav__item"><a href="#health-benefits">Health Benefits</a></li>
        <li class="mobile-nav__item"><a href="#education-benefits">Education Benefits</a></li>
        <li class="mobile-nav__item"><a href="#employment-benefits">Employment Benefits</a></li>
        <li class="mobile-nav__item"><a href="#climate-benefits">Climate & Environmental Benefits</a></li>
        <li class="mobile-nav__item"><a href="index.php#contact">Contact</a></li>
    </ul>
</nav>

   <main>
    <article class="flex-columns flex-reverse" id="health-benefits">
        <div class="row">
        <?php
            include('connect.php');
    ...
    <article class="flex-columns flex-reverse" id="education-benefits">
        <div class="row">
        <?php
            include('connect.php');
    ...
    <article class="flex-columns flex-reverse" id="employment-benefits">
        <div class="row">
        <?php
            include('connect.php');
            $sql="SELECT * FROM content where id=11";
            $results=$conn->query($sql);
            while($final=$results->fetch_assoc()){?>
            <div class="column">
                <div class="column-1">
    ...
    <article class="flex-columns flex-reverse" id="climate-benefits">
        <div class="row">
        <?php
            include('connect.php');
            $sql="SELECT * FROM content where id=12";
            $results=$conn->query($sql);
            while($final=$results->fetch_assoc()){?>
            <div class="column">
                <div class="column-2 bg-light">
